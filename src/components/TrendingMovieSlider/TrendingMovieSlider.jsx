...
function TrendingMovieSlider() {
    ...
    const fetchData = async () => {
      try {
        const response = await fetch(
          "https://api.themoviedb.org/3/trending/movie/day?api_key=c891d1e6ccfd10d508f441af7c38c344"
        );
  ...
  return (
    <div className="flex flex-col my-10 px-10">
      <h1 className="font-bold text-xl text-white">Trending Movies</h1>
      ...
      >
        {trendingMovieData?.results?.map((movie) => (
